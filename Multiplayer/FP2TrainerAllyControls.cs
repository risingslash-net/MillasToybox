...
namespace RisingSlash.FP2Mods.MillasToybox
{
    public static class FP2TrainerAllyControls
    {
        ...
        {
	        showAllyControlDebugs = MillasToybox.multiplayerStart;

	        if (showAllyControlDebugs)
	        {
		        MillasToybox.Log(str + "\n");
	        }
        }
        ...
        {
	        FP2TrainerInputQueue ipq;
	        if (String.IsNullOrEmpty(MillasToybox.DEBUG_LoadSpecificGhostFile.Value))
	        {
		        MillasToybox.Log("Loading most recent");
		        ipq = FP2TrainerInputQueue.LoadQueueFromFileMostRecent();
	        }
	        else
	        {
		        MillasToybox.Log($"Loading from file: {MillasToybox.DEBUG_LoadSpecificGhostFile.Value}");
		        ipq = FP2TrainerInputQueue.LoadQueueFromFile(MillasToybox.DEBUG_LoadSpecificGhostFile.Value);
	        }
        ...
        {
	        FP2TrainerInputQueue ipq;
	        ConfigEntry<string> ghostFilePrefToCheck;
	        switch (playerNum)
	        {
		        case 0:
			        ghostFilePrefToCheck = MillasToybox.DEBUG_LoadSpecificGhostFile;
			        break;
		        case 1:
			        ghostFilePrefToCheck = MillasToybox.DEBUG_LoadSpecificGhostFileP2;
			        break;
		        case 2:
			        ghostFilePrefToCheck = MillasToybox.DEBUG_LoadSpecificGhostFileP3;
			        break;
		        case 3:
			        ghostFilePrefToCheck = MillasToybox.DEBUG_LoadSpecificGhostFileP4;
			        break;
		        default:
			        ghostFilePrefToCheck = MillasToybox.DEBUG_LoadSpecificGhostFile;
			        break;
	        ...
	        {
		        MillasToybox.Log($"Loading from file: {ghostFilePrefToCheck.Value}");
        ...
        {
            allPlayers = MillasToybox.fpplayers;
            leadPlayer = MillasToybox.fpplayer;
        }
        ...
        public static void HandleAllyControlsGhost(this FPPlayer fpp)
        {
	        ...
	        if (needToLoadInputs)
	        {
		        MillasToybox.Log("Need to load inputs from file. Grabbing most recent / from configs.");
	        ...
	        {
		        MillasToybox.Log($"Ghost is expecting characterID {ipq.charID.ToString()}, " +
	        ...
	        MillasToybox.Log(funky);
	        
	        //MillasToybox.debugDisplay = funky + "\n" + MillasToybox.debugDisplay;
        ...
        public static void CyclePreferredAllyControlType()
        {
            ...
            MillasToybox.PreferredAllyControlTypeLastSetting.Value = allyControlTypeName;
            MillasToybox.Log("Preferred Ally Control Type Set To: " + allyControlTypeName);
        ...
        public static FPObjectState GetInputMethodFromPreferredAllyControlType(FPPlayer fpp)
        {
	        ...
	        MillasToybox.Log("Set control type to " + AllyControlTypeName(preferredAllyControlType));
	        MillasToybox.Log("(But actually, it's set to" + actually + ")");
	        return result;
        }
